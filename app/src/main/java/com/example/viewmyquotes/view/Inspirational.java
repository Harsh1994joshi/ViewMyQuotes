...
public class Inspirational extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.inspiview);
        list=new ArrayList<>();
        databaseReference= FirebaseDatabase.getInstance().getReference("NewQuotes").child("Inspirational");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                MyAdapter myAdapter= new MyAdapter(Inspirational.this,list);
